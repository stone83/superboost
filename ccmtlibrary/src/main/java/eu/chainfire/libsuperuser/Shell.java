...
public class Shell {
    ...
    public static class Interactive {
            ...
            if (onCommandResultListener != null) {
                ...
                commands.add(0, new Command(Shell.availableTestCommands, 0, new OnCommandResultListener() {
                    public void onCommandResult(int commandCode, int exitCode, List<String> output) {
                        LLog.i("Shell.availableTestCommands=" + Shell.availableTestCommands
                                + " commandCode=" + commandCode + " exitCode=" + exitCode + "  output=" + output);
        ...
        private void postCallback(final Command fCommand, final int fExitCode,
            ...
            LLog.i(" fCommand=" + fCommand + " fExitcode=" + fExitCode + " foutput=" + fOutput);
    ...
    static class LLog {
        public static final String TAG = "CCMTNetworkController";

        public static void i() {
            Log.i(TAG, "[" + getFileLineMethod() + "]");
        }
